...
```bash
python -m src.enroll --name patience
```
...
```bash
python src/vision_node.py --broker 157.173.101.159 --name patience
```
...
**URL**: [[http://157.173.101.159:9313/]](http://157.173.101.159:9313/])
